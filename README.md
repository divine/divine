...
- [unjs/ufo](https://github.com/unjs/ufo) ([v1.5.1](https://github.com/unjs/ufo/releases/tag/v1.5.1), 2 days ago) - 🔗 URL utils for humans
- [api-platform/core](https://github.com/api-platform/core) ([v3.2.17](https://github.com/api-platform/core/releases/tag/v3.2.17), 2 days ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
- [nuxt/nuxt](https://github.com/nuxt/nuxt) ([v3.10.3](https://github.com/nuxt/nuxt/releases/tag/v3.10.3), 3 weeks ago) - The Intuitive Vue Framework.
