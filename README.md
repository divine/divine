...
- [nuxt/nuxt](https://github.com/nuxt/nuxt) ([v3.1.2](https://github.com/nuxt/nuxt/releases/tag/v3.1.2), 3 days ago) - Nuxt is an intuitive and extendable way to create type-safe, performant and production-grade full-stack web apps and websites with Vue 3.
- [api-platform/core](https://github.com/api-platform/core) ([v3.1.2](https://github.com/api-platform/core/releases/tag/v3.1.2), 3 days ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
