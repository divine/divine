...
- [doctrine/DoctrineMongoDBBundle](https://github.com/doctrine/DoctrineMongoDBBundle) ([5.0.0-RC1](https://github.com/doctrine/DoctrineMongoDBBundle/releases/tag/5.0.0-RC1), today) - Integrates Doctrine MongoDB ODM with Symfony
- [api-platform/core](https://github.com/api-platform/core) ([v3.2.9](https://github.com/api-platform/core/releases/tag/v3.2.9), 2 days ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
