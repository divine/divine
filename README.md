...
- [api-platform/core](https://github.com/api-platform/core) ([v3.0.8](https://github.com/api-platform/core/releases/tag/v3.0.8), 1 day ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
