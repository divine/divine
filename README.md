...
- [nuxt/framework](https://github.com/nuxt/framework) ([v3.0.0](https://github.com/nuxt/framework/releases/tag/v3.0.0), 2 days ago) - The Intuitive Web Framework, based on Vue 3.
- [api-platform/core](https://github.com/api-platform/core) ([v3.0.4](https://github.com/api-platform/core/releases/tag/v3.0.4), 3 days ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
