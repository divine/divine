...
- [mongodb/laravel-mongodb](https://github.com/mongodb/laravel-mongodb) ([4.0.0-rc1](https://github.com/mongodb/laravel-mongodb/releases/tag/4.0.0-rc1), 6 days ago) - A MongoDB based Eloquent model and Query builder for Laravel (Moloquent)
