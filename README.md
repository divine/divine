...
- [api-platform/core](https://github.com/api-platform/core) ([v2.7.9](https://github.com/api-platform/core/releases/tag/v2.7.9), today) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
