...
- [nuxt/nuxt](https://github.com/nuxt/nuxt) ([v2.16.2](https://github.com/nuxt/nuxt/releases/tag/v2.16.2), 4 days ago) - Nuxt is an intuitive and extendable way to create type-safe, performant and production-grade full-stack web apps and websites with Vue 3.
- [api-platform/core](https://github.com/api-platform/core) ([v3.0.12](https://github.com/api-platform/core/releases/tag/v3.0.12), 5 days ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
...
- [jenssegers/laravel-mongodb](https://github.com/jenssegers/laravel-mongodb) ([v3.9.5](https://github.com/jenssegers/laravel-mongodb/releases/tag/v3.9.5), 2 weeks ago) - A MongoDB based Eloquent model and Query builder for Laravel (Moloquent)
