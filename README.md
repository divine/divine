...
- [jenssegers/laravel-mongodb](https://github.com/jenssegers/laravel-mongodb) ([v3.9.0](https://github.com/jenssegers/laravel-mongodb/releases/tag/v3.9.0), 2 days ago) - A MongoDB based Eloquent model and Query builder for Laravel (Moloquent)
