...
- [mongodb/laravel-mongodb](https://github.com/mongodb/laravel-mongodb) ([v4.0.0-ALPHA2](https://github.com/mongodb/laravel-mongodb/releases/tag/v4.0.0-ALPHA2), 3 days ago) - A MongoDB based Eloquent model and Query builder for Laravel (Moloquent)
