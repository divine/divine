...
- [unjs/ufo](https://github.com/unjs/ufo) ([v1.5.3](https://github.com/unjs/ufo/releases/tag/v1.5.3), 3 days ago) - 🔗 URL utils for humans
- [nuxt/nuxt](https://github.com/nuxt/nuxt) ([v3.11.1](https://github.com/nuxt/nuxt/releases/tag/v3.11.1), 5 days ago) - The Intuitive Vue Framework.
- [api-platform/core](https://github.com/api-platform/core) ([v3.2.17](https://github.com/api-platform/core/releases/tag/v3.2.17), 1 week ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
