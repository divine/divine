...
- [jenssegers/laravel-mongodb](https://github.com/jenssegers/laravel-mongodb) ([v3.9.1](https://github.com/jenssegers/laravel-mongodb/releases/tag/v3.9.1), today) - A MongoDB based Eloquent model and Query builder for Laravel (Moloquent)
