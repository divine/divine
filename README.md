...
- [mongodb/laravel-mongodb](https://github.com/mongodb/laravel-mongodb) ([4.0.2](https://github.com/mongodb/laravel-mongodb/releases/tag/4.0.2), today) - A MongoDB based Eloquent model and Query builder for Laravel (Moloquent)
