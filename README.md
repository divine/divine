...
- [nuxt/content](https://github.com/nuxt/content) ([@nuxt/content@1.15.0](https://github.com/nuxt/content/releases/tag/%40nuxt%2Fcontent%401.15.0), 3 days ago) - Nuxt Content lets you write in a content/ directory and fetch your Markdown, JSON, YAML, XML and CSV files through a MongoDB like API, acting as a Git-based Headless CMS
...
- [api-platform/api-platform](https://github.com/api-platform/api-platform) ([v2.6.6](https://github.com/api-platform/api-platform/releases/tag/v2.6.6), 4 weeks ago) - Create REST and GraphQL APIs, scaffold Jamstack webapps, stream changes in real-time.
