...
- [nuxt/nuxt](https://github.com/nuxt/nuxt) ([v2.16.1](https://github.com/nuxt/nuxt/releases/tag/v2.16.1), 1 day ago) - Nuxt is an intuitive and extendable way to create type-safe, performant and production-grade full-stack web apps and websites with Vue 3.
- [jenssegers/laravel-mongodb](https://github.com/jenssegers/laravel-mongodb) ([v3.9.4](https://github.com/jenssegers/laravel-mongodb/releases/tag/v3.9.4), 3 days ago) - A MongoDB based Eloquent model and Query builder for Laravel (Moloquent)
