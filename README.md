...
- [nuxt/content](https://github.com/nuxt/content) ([@nuxt/content@1.15.0](https://github.com/nuxt/content/releases/tag/%40nuxt%2Fcontent%401.15.0), 4 days ago) - Nuxt Content lets you write in a content/ directory and fetch your Markdown, JSON, YAML, XML and CSV files through a MongoDB like API, acting as a Git-based Headless CMS
