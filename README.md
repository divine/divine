...
- [nuxt/nuxt](https://github.com/nuxt/nuxt) ([v2.18.1](https://github.com/nuxt/nuxt/releases/tag/v2.18.1), 2 days ago) - The Intuitive Vue Framework.
- [api-platform/core](https://github.com/api-platform/core) ([v3.3.7](https://github.com/api-platform/core/releases/tag/v3.3.7), 2 days ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
